...
DATA = $(desktop_DATA) $(glade_DATA) $(pixmap_DATA)
RECURSIVE_CLEAN_TARGETS = mostlyclean-recursive clean-recursive	\
  distclean-recursive maintainer-clean-recursive
ETAGS = etags
CTAGS = ctags
DIST_SUBDIRS = intl src doc po
...
abs_builddir = /home/rmcguire/Downloads/c/btnx-config-0.4.9
abs_srcdir = /home/rmcguire/Downloads/c/btnx-config-0.4.9
...
installdirs-am:
	for dir in "$(DESTDIR)$(desktopdir)" "$(DESTDIR)$(gladedir)" "$(DESTDIR)$(pixmapdir)"; do \
...
.PHONY: $(RECURSIVE_CLEAN_TARGETS) $(RECURSIVE_TARGETS) CTAGS GTAGS \
	...
	uninstall-gladeDATA uninstall-local uninstall-pixmapDATA
